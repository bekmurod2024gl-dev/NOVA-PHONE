...
function Products() {
  ...
  const filtered = catalog.filter((p) => {
    ...
    const matchesSearch = p.name.toLowerCase().includes(searchText) || p.brand.toLowerCase().includes(searchText);
          ...
          return (
            <div className="product-card" key={product.id}>
              <div className="product-image">
                {/* Rasm to'g'ridan-to'g'ri public/images dan olinadi */}
                <img
                  src={product.image}
                  alt={product.name}
                  loading="lazy"
                ...
                <button className={`shop-like-btn ${liked.includes(product.id) ? "liked" : ""}`} onClick={() => toggleLike(product.id)}>
